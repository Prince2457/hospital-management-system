...
- **Appointments** - Book appointments with conflict detcetion, cancel with status protection
...
- **Authentication** - Secure login with bcrypt password hashing and role_based access control (in progress)

##  🛠️ Tech Stack
- **Language:** Python 3.13
- **Database:** MySQL
- **Libraries:** mysql-connector-python, python-dotenv, bcrypt, colorama
...
- Role-based access — 13 user roles with different permissions
